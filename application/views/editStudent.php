              ...
              <div class="form-group">
                         ...
                         <div class="col-md-9">
                              <?php echo form_input (['name' => 'studentname', 'class'=> 'form-control'
                                , 'placeholder'=> 'Student Name', 'value' => set_value('studentname', $studentData -> studentname)]); ?>
                                </div>
                            </div>
                        </div>
                    </div class="col-md-6">
              ...
              <div class="form-group">
                         ...
                         <div class="col-md-9">
                              <?php echo form_input (['name' => 'email', 'class'=> 'form-control'
                                , 'placeholder'=> 'email', 'value' => set_value('email', $studentData -> email)]); ?>
                                </div>
                            </div>
                        </div>
                    </div class="col-md-6">
      ...
      <div class="row">
           ...
           <div class="col-md-6">
              <div class="form-group">
                         ...
                         <div class="col-md-9">
                              <?php echo form_input (['name' => 'course', 'class'=> 'form-control'
                                , 'placeholder'=> 'Course', 'value' => set_value('course', $studentData -> course)]); ?>
                                </div>
                            </div>
                        </div>
                    </div class="col-md-6">
             ...
             <?php echo anchor ("admin/viewStudents/{$studentData->id}", "BACK", ['class'
							=> 'btn btn-primary']);?>
     <div>
         <?php echo form_close(); ?>
    </div>  
